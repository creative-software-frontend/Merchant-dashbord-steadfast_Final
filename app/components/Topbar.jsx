...
// import ProfileMenu from "./topbar/Profile";
// import LanguageToggle from "./topbar/LanguageToggle";
// import ParcelDetails from "./tracking-parcel/ParcelDetails";
...
//         `https://system.packnexa.com/api/order-view?tracking_id=${trackingId}`
//       );
...
//                     className="px-4 py-2.5 border border-[#a3a3a3] rounded-full w-48 lg:w-60 focus:outline-none transition-all duration-300 hover:border-gray-400 focus:border-[#a3a3a3]"
//                   />
//                   <FaSearch  onClick={handleSearch} className="absolute right-3 top-3 text-gray-400 transition-colors duration-200" />
//                 </div>
...
//       {orderData && <ParcelDetails order={orderData} />}
//     </div>
//   );
// };
