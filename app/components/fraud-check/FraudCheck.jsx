...
const FraudCheck = () => {
  ...
  const data = [
    { merchant: "AKHSARA", order: 2, delivery: 0, return: 0, successRate: "0%" },
    { merchant: "parcelion courier", order: 2, delivery: 0, return: 0, successRate: "0%" },
  ];
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-6">
      ...
      <button className="button-primary cursor-pointer text-white px-4 py-2 rounded flex items-center gap-2">
        ...
        <div className="bg-green-100 text-green-800 p-4 rounded mb-4 text-sm ">
          <p className="my-2">This customer does not appear credible; therefore, it is advisable to refrain from placing any further orders.</p>
